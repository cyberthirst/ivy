...
def exclude_unsupported_patterns(test_filter: TestFilter) -> TestFilter:
    ...
    return (
        ...
        .exclude_source(r"\.code\b")
        .exclude_source(r"\.codesize\b")
        .exclude_source(r"\.codehash\b")
        .exclude_source(r"(?s)create_copy_of\([^)]*\bsalt\s*=")
        .exclude_source(r"(?s)create_from_blueprint\([^)]*\bsalt\s*=")
